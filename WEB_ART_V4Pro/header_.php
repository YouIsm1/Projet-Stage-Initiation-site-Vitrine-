                ...
                width: 90%;
                    ...
                    <header class="di_head">
                        ...
                        <div class="navigation">
                            <nav class="the_nav">
                                <ul class="the_links">
                                    <li class="links"><a href="page_acceuille.php">accueil</a></li>
                                    <li class="links"><a href="web_produits.php">produis</a></li>
                                    <li class="links"><a href="a_propose.php">a propos de nous</a></li>
                                    <!-- <li class="links"><a href="web_profile.php">profile</a></li> -->
                                    <li class="links"><a href="page_connection.php">connection</a></li>
                                </ul>
                            </nav>
                        </div>
                    </header>
